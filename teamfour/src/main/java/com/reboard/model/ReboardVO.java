...
public class ReboardVO {
	...
	public ReboardVO(int num, String writer, String email, String subject, String password, String reg_date, int ref,
	...
	public String toString() {
		return "ReboardVO [num=" + num + ", writer=" + writer + ", email=" + email + ", subject=" + subject
